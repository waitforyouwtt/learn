...
public class ReadFromFile {
    ...
    public static void read() throws IOException {
        File fileIn= new File("F:\\readText.txt");
        File fileOut= new File("F:\\readText2.txt");
        ...
        while ((lineWriter = reader.readLine()) != null) {
            ...
            System.out.println("line " + line + ": " + lineWriter);
            writer.newLine();
            writer.flush();
            line ++;
        }
